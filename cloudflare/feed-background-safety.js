...
export const WHITELIST_QUERIES = [
...
export const STRICT_BOOL_FIELDS = [
  "containsHumans",
  "containsFaces",
  "containsBodyParts",
  "containsNudity",
...
export function buildHaystack(candidate, opts) {
...
export function containsForbiddenKeyword(text) {
...
export function deriveSafetyFlags(hay) {
  return {
...
export function validateCandidate(candidate, settings) {
...
export function isStrictFeedBgSafe(item, settings) {
...
export function sortQueriesNatureFirst(queries) {
