...
RAW="https://raw.githubusercontent.com/Sero91ak/dar-al-tawhid-site/5b05ac896edaec747a6f79c9763690e119045e5e"
...
curl -fsSL "$RAW/voice-studio/local-engine.py?v=233" -o "$STAGE/local-engine.py"
curl -fsSL "$RAW/voice-studio/index.html?v=233" -o "$STAGE/studio.html"
curl -fsSL "$RAW/data/pronunciation/pronunciation-rules.json?v=233" -o "$STAGE/pronunciation-rules.json"
curl -fsSL "$RAW/data/pronunciation/voice-production-profile.json?v=233" -o "$STAGE/voice-production-profile.json"
curl -fsSL "$RAW/data/pronunciation/voice-regression-fixtures.json?v=233" -o "$STAGE/voice-regression-fixtures.json"
curl -fsSL "$RAW/scripts/voice-studio/validate-v2.py?v=233" -o "$STAGE/validate-v2.py"
curl -fsSL "$RAW/watermark-my-logo-full.png?v=233" -o "$STAGE/watermark-my-logo-full.png" || true
curl -fsSL "$RAW/app-icon-512.png?v=233" -o "$STAGE/app-icon-512.png" || true
