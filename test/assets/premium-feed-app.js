...
(function (global) {
  ...
  var FEED_COL_FOLD = 0;
  var FEED_COL_TABLET = 0;
  var FEED_COL_DESKTOP = 0;
  var FEED_SHELL_PAD = 0;
  var FEED_CARD_GAP = 12;
  var FEED_CARD_RADIUS = 16;
  ...
  function injectStyles() {
    ...
    var css =
      ...
      '.sf-top{position:sticky;top:0;z-index:8;padding:12px var(--sf-gutter-right,var(--sf-shell-pad,0px)) 10px var(--sf-gutter-left,var(--sf-shell-pad,0px));background:var(--theme-feed-bg,var(--outer-bg,var(--bg)));border-bottom:1px solid var(--theme-feed-head-border,var(--theme-border,var(--line)));backdrop-filter:none;-webkit-backdrop-filter:none;width:100%;max-width:100%;margin-left:0;margin-right:0;box-sizing:border-box}' +
      ...
      'html[data-theme="eisgold"] .sf-brand-title,html[data-theme="eisgold"] .sf-brand h1,html[data-theme="eisgold"] .sf-read-more,html[data-theme="eisgold"] .sf-brand-kicker,html[data-theme="eisgold"] .sf-switch-btn,html[data-theme="eisgold"] .sf-sub,html[data-theme="eisgold"] .sf-user{color:#0a1628!important;-webkit-text-fill-color:#0a1628!important}' +
      'html[data-theme="eisgold"] .sf-top{background:#fcfeff!important;background-color:#fcfeff!important;border-bottom:0!important;box-shadow:none!important}' +
      'html[data-theme="eisgold"] .sf-switch{border-radius:999px!important;border:1px solid rgba(200,169,90,.32)!important;background:#ffffff!important}' +
      'html[data-theme="eisgold"] .sf-switch-btn.is-active{background:rgba(200,169,90,.18)!important;background-image:none!important;color:#142033!important;box-shadow:none!important}' +
      'html[data-theme="eisgold"] .sf-refresh{background:#ffffff!important;border:1px solid rgba(200,169,90,.35)!important;color:#142033!important;box-shadow:none!important}' +
      ...
      '.sf-filters{display:flex;gap:7px;overflow-x:auto;padding:2px var(--sf-gutter-right,var(--sf-shell-pad,0px)) 12px var(--sf-gutter-left,var(--sf-shell-pad,0px));scrollbar-width:none;-webkit-overflow-scrolling:touch;width:100%;max-width:100%;margin-left:0;margin-right:0;box-sizing:border-box}' +
      ...
      '.sf-feed{display:flex;flex-direction:column;gap:var(--sf-card-gap,12px);padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px));width:100%;max-width:100%;box-sizing:border-box;margin-left:0;margin-right:0;min-width:0}' +
      '.sf-post{margin:0;border-radius:var(--sf-card-radius,18px);overflow:hidden;cursor:pointer;background:var(--theme-feed-card,var(--theme-surface,transparent));border:1px solid var(--theme-border,var(--line));box-shadow:var(--premium-shadow,none);width:100%;max-width:100%;min-width:0;box-sizing:border-box;align-self:stretch}' +
      '.sf-post--image-feed{cursor:default;border:1px solid var(--theme-border,var(--line));background:var(--theme-feed-card,var(--theme-surface,transparent));box-shadow:var(--premium-shadow,0 12px 32px rgba(0,0,0,.18));position:relative;max-width:100%;width:100%;margin:0;overflow:hidden;box-sizing:border-box}' +
      ...
      'body.is-feed-fullscreen .sf-app{display:flex;flex-direction:column;width:100%;max-width:100%;background:var(--theme-feed-bg,var(--outer-bg,var(--bg)));box-sizing:border-box;align-items:stretch}' +
      'body.is-feed-fullscreen .sf-top,body.is-feed-fullscreen .sf-filters,body.is-feed-fullscreen .sf-feed{width:100%;max-width:100%;margin-left:0;margin-right:0}' +
      'body.is-feed-fullscreen .sf-feed{padding:0 var(--sf-gutter-right,max(8px,env(safe-area-inset-right,0px))) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,max(8px,env(safe-area-inset-left,0px)));gap:var(--sf-card-gap,12px);max-width:100%;margin-left:0;margin-right:0;width:100%;box-sizing:border-box;min-width:0}' +
      'body.is-feed-fullscreen .sf-post{border-radius:var(--sf-card-radius,18px);margin:0;border:none;background:var(--theme-feed-card,var(--theme-surface,transparent));box-shadow:var(--premium-shadow,none);width:100%;max-width:100%;min-width:0;box-sizing:border-box;align-self:stretch}' +
      ...
      'body.is-feed-fullscreen .sf-top,body.is-feed-fullscreen .sf-filters{max-width:100%;margin-left:0;margin-right:0}' +
      'body.is-feed-fullscreen .sf-top{padding-left:var(--sf-gutter-left,var(--sf-shell-pad,0px));padding-right:var(--sf-gutter-right,var(--sf-shell-pad,0px))}' +
      'body.is-feed-fullscreen .sf-filters{padding-left:var(--sf-gutter-left,var(--sf-shell-pad,0px));padding-right:var(--sf-gutter-right,var(--sf-shell-pad,0px))}' +
      ...
      '@media(max-width:700px){.sf-feed{padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px))}body.is-feed-fullscreen .sf-feed{padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px))}.sf-feed,.sf-top,.sf-filters{max-width:100%;margin-left:0;margin-right:0;width:100%;box-sizing:border-box}}' +
      '@media(max-width:360px){.sf-brand-signature{font-size:9px}.sf-brand-chip{font-size:6px;padding:1px 4px}}' +
      '@media(min-width:600px){body.is-feed-fullscreen .sf-feed,body.is-feed-fullscreen .sf-top,body.is-feed-fullscreen .sf-filters,.sf-post--image-feed{max-width:100%!important;margin-left:0!important;margin-right:0!important;width:100%!important}}' +
