/**
 * DAR AL TAWḤĪD — Propheten Wissensbibliothek (Test App only)
 * Claim-based profiles · master-detail by viewport width · no UA detection.
 */
(function (global) {
  "use strict";

  var DATA_BASE = "/test/data/prophets/";
  var DUAL_MIN = 720;
  ...
  function setPageHeaderSafe() {
    if (typeof global.setPageHeader === "function") {
      return global.setPageHeader(
        "Die Propheten",
        "Qurʾān · Sunnah · geprüfte Überlieferungen",
        "Propheten"
      );
    }
    if (typeof global.setHeader === "function") {
      return global.setHeader("Die Propheten", "Qurʾān · Sunnah · geprüfte Überlieferungen", "Propheten");
    }
    return "";
  }
  ...
  function render(routeValue) {
    if (!isTest()) {
      return '<div class="empty">Dieser Bereich ist nur in der Test-App verfügbar.</div>';
    }
