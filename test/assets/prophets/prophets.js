...
(function (global) {
  ...
  function renderSpotlight() {
    ...
    return (
      ...
      '<span class="feature-icon prophets-spotlight__icon" aria-hidden="true"><img class="dar3d-icon" src="/test/assets/dar-3d-icons/prophets.png?v=1047" alt="" decoding="async"></span>' +
