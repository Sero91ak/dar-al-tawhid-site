// workers-deploy-stamp:1786198796383
...
const CACHE_VERSION = 'dar-al-tawhid-offline-light-v852';
...
const APP_SHELL = [
  ...
  '/test/index.html',
  '/test/version.json',
  '/test/assets/quran-player-test.js',
  '/test/assets/quran-player-test.css',
  '/manifest.json',
  ...
  '/test/data/frauen-muetter-der-glaeubigen.json',
  '/test/data/frauen-ehe-familie.json',
  '/test/data/frauen-hijab-schamhaftigkeit.json',
  '/test/data/frauen-wissen-lernen.json',
  ...
  '/test/data/frauen-hajj-umrah.json',
  '/test/data/frauen-sadaqah-wohltatigkeit.json',
  '/test/data/frauen-adab-charakter.json',
  '/test/data/frauen-kinder-erziehung.json',
  '/test/data/frauen-rechtschaffene-muslimah.json',
  '/test/data/frauen-schwangerschaft-stillzeit-nifas.json',
  '/test/data/frauen-dienst-pflege-hilfeleistung.json',
  '/test/data/frauen-iddah-scheidung-trauerzeit.json',
  '/test/data/frauen-reinigung-gebet-fasten.json',
  '/test/data/frauen-nikah-zustimmung-mahr.json',
  '/test/data/frauen-zinah-schmuck-kleidung.json',
  '/test/data/frauen-umgang-nicht-maharim.json',
  '/test/data/frauen-reise-mahram-schutz.json',
  '/test/data/frauen-krankheit-pruefung-geduld.json',
  '/test/data/frauen-privatsphaere-erlaubnis-haus-adab.json',
  ...
  '/test/data/frauen-geprueftes-wissen-quellen-weitergabe.json',
  '/test/data/frauen-tod-janazah-trauer-adab.json',
  '/test/data/frauen-arbeit-studium-oeffentlichkeit.json',
  '/test/data/frauen-medien-bilder-oeffentliche-darstellung.json',
  '/test/data/frauen-ruqyah-schutz-zuflucht.json',
  '/test/data/frauen-tod-janazah-trauer.json',
  '/test/data/frauen-maedchen-pubertaet-pflichtwissen.json',
  '/test/data/frauen-falsches-wissen-bidah-quellenpruefung.json',
  '/test/data/frauen-reue-istighfar-rueckkehr.json',
  '/test/data/frauen-tod-janaiz-trauer-sabr.json',
  '/test/data/frauen-reue-tawbah-istighfar.json',
  '/test/data/frauen-toechter-maedchen-fuersorge.json',
