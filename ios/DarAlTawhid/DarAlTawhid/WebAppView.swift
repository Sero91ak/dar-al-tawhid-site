...
struct WebAppView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIView {
        ...
        (function(){
          ...
          window.__DAR_IOS_BUILD__="0.18-web-parity-v649";
          ...
          function ensureStyle(){
            ...
            var feedForce=document.getElementById("dar-ios-parity-edge-force-v649")||document.getElementById("dar-ios-parity-edge-force-v648")||document.getElementById("full-edge-feed-force-v645")||document.getElementById("full-edge-feed-force-v644");
        ...
        webView.customUserAgent = "DarAlTawhid-iOS-TestFlight/0.18-web-parity-v649"
