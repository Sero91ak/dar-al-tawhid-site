        ...
        (function(){
          try{
            ...
            if(root){
              ...
              root.removeAttribute("data-dar-ios-no-glass");
              root.setAttribute("data-dar-ios-top-solid","1");
            }
            if(document.getElementById("dar-ios-top-solid-boot"))return;
            var s=document.createElement("style");
            s.id="dar-ios-top-solid-boot";
            s.textContent="html.dar-ios-native-app{--dar-app-top-solid:var(--quran-page-bg,var(--theme-feed-bg,var(--dar-edge-fill,var(--page-cover,var(--outer-bg-flat,var(--bg,#050706))))))}html.dar-ios-native-app .top-shell,html.dar-ios-native-app .header,html.dar-ios-native-app .header.theme-hero-surface,html.dar-ios-native-app .sf-top,html.dar-ios-native-app .qov-header,html.dar-ios-native-app .app-bar,html.dar-ios-native-app .view-head,html.dar-ios-native-app .settings-page-head{-webkit-backdrop-filter:none!important;backdrop-filter:none!important;filter:none!important;background:var(--dar-app-top-solid)!important;background-color:var(--dar-app-top-solid)!important;background-image:none!important}html.dar-ios-native-app .top-edge-fade,html.dar-ios-native-app #topEdgeFade,html.dar-ios-native-app .top-swim-aura,html.dar-ios-native-app #topSwimAura{display:none!important;visibility:hidden!important;opacity:0!important;height:0!important;background:none!important;filter:none!important;pointer-events:none!important}html.dar-ios-native-app .top-shell:before,html.dar-ios-native-app .top-shell:after,html.dar-ios-native-app .header:before,html.dar-ios-native-app .header:after,html.dar-ios-native-app .sf-top:before,html.dar-ios-native-app .sf-top:after,html.dar-ios-native-app .qov-header:before,html.dar-ios-native-app .qov-header:after,html.dar-ios-native-app .app-bar:before,html.dar-ios-native-app .app-bar:after{content:none!important;display:none!important;opacity:0!important;background:none!important;filter:none!important;-webkit-backdrop-filter:none!important;backdrop-filter:none!important}html.dar-ios-native-app .app:after,html.dar-ios-native-app .app::after{content:none!important;display:none!important}html.dar-ios-native-app #darQuranMiniPlayer{box-shadow:none!important;filter:none!important}html.dar-ios-native-app #bottomNav.bottom-nav{isolation:auto!important;contain:none!important}";
        ...
        (function(){
          ...
          function cssText(){
            return [
              ...
              "html.dar-ios-native-app #footerAppSave,html.dar-ios-native-app .footer-app-save,html.dar-ios-native-app .footer-action-save{display:none!important;visibility:hidden!important;width:0!important;height:0!important;overflow:hidden!important;}",
              "html.dar-ios-native-app .footer-actions,html.dar-ios-native-app .footer .footer-actions,html.dar-ios-native-app body.is-home-route .footer .footer-actions{display:flex!important;flex-wrap:nowrap!important;justify-content:center!important;align-items:stretch!important;grid-template-columns:none!important;gap:8px!important;width:min(430px,calc(100% - 16px))!important;max-width:430px!important;margin:12px auto 0!important;}",
              "html.dar-ios-native-app .footer-actions .footer-action-btn,html.dar-ios-native-app .footer-actions .footer-social-link{flex:1 1 0!important;max-width:140px!important;margin:0!important;}",
