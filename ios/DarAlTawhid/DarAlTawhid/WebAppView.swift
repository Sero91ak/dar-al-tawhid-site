...
struct WebAppView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIView {
        ...
        (function(){
          ...
          window.__DAR_IOS_BUILD__="0.17-web-parity";
          /* Web assets (full-edge-appearance-polish + feed force + soft-boot) own layout.
          ...
          function ensureStyle(){
            ...
            var feedForce=document.getElementById("full-edge-feed-force-v645")||document.getElementById("full-edge-feed-force-v644");
        ...
        webView.customUserAgent = "DarAlTawhid-iOS-TestFlight/0.17-web-parity"
