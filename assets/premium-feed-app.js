...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css =
      ...
      '.sf-filters{display:flex;gap:7px;overflow-x:auto;padding:2px var(--sf-gutter-right,var(--sf-shell-pad,0px)) 12px var(--sf-gutter-left,var(--sf-shell-pad,0px));scrollbar-width:none;-webkit-overflow-scrolling:touch;width:100%;max-width:var(--sf-feed-col-max,100%);margin-left:auto;margin-right:auto;box-sizing:border-box}' +
      ...
      'body.is-feed-fullscreen .sf-feed{padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px));gap:var(--sf-card-gap,12px);max-width:var(--sf-feed-col-max,100%);margin-left:auto;margin-right:auto;width:100%;box-sizing:border-box;min-width:0}' +
      ...
      '@media(max-width:700px){.sf-feed{padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px))}body.is-feed-fullscreen .sf-feed{padding:0 var(--sf-gutter-right,var(--sf-shell-pad,0px)) calc(24px + env(safe-area-inset-bottom)) var(--sf-gutter-left,var(--sf-shell-pad,0px))}.sf-feed,.sf-top,.sf-filters{max-width:var(--sf-feed-col-max,100%);margin-left:auto;margin-right:auto;width:100%;box-sizing:border-box}}' +
